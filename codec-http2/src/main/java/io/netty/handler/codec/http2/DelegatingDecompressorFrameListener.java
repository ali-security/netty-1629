...
public class DelegatingDecompressorFrameListener extends Http2FrameListenerDecorator {
    ...
    private final class ConsumedBytesConverter implements Http2LocalFlowController {
        ...
        public boolean consumeBytes(Http2Stream stream, int numBytes) throws Http2Exception {
            // In the new architecture, byte conversion is handled directly in the decompressor's
            // ChannelInboundHandlerAdapter, so we just pass through to the underlying flow controller.
            try {
